          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Pickup: {order.pickupTime}</p>
              </div>
            </div>
            <div className="text-right">
              <p className="text-xl font-bold text-green-600 dark:text-green-400">₹{order.amount}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">{order.distance} km</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{order.pickup}</p>
              </div>
            </div>
            <div className="flex items-start gap-2">
              <svg
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">{order.drop}</p>
              </div>
            </div>
          </div>
