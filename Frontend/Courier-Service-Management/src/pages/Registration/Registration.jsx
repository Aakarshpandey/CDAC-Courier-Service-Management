...
export default function Registration() {
  ...
  const handleSubmit = () => {
    ...
    console.log('Registration submitted:', { ...formData, accountType, wantsUpdates });
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-2xl font-semibold text-gray-800">courierKaro</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-4 sm:p-8">
          <div className="text-center mb-6">
            <h1 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-2">Create Your Account</h1>
            <p className="text-gray-600 text-sm">Join thousands of users who trust us with their deliveries</p>
          </div>
          ...
          <div>
            ...
            <div className="mb-6 flex flex-wrap gap-3 text-xs">
              ...
              <span className={passwordRequirements.hasSpecial ? 'text-green-600' : 'text-gray-400'}>
                1 special character
              </span>
            </div>
